...
ADMINS = [("""Starlin&Randae""", "starlin&randae@example.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "backend_django API",
    "DESCRIPTION": "Documentation of API endpoints of backend_django",
    "VERSION": "1.0.0",
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:8080",
    "http://127.0.0.1:8000",
    "http://localhost:3000",  # Puerto por defecto de Flutter web
...
# Para desarrollo, puedes usar esto (NO en producción)
